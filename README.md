...
<img width="652" alt="udaconnect-app" src="https://user-images.githubusercontent.com/24944117/148259776-26179f9f-196e-439c-86d7-7ccd4b881bb4.png">
...
7. `kubectl apply -f deployment/create-location-grpc.yaml` - Set up the service and deployment for location post gRPC
8. `kubectl apply -f deployment/frontend.yaml` - Set up the service and deployment for the web app
...
`kubectl get pods` and `kubectl get services` - should both return `frontend`,`location-api`,`person-api`, `location-grpc`, and `postgres`


These pages should also load on your web browser:
* `http://localhost:30011/` - OpenAPI Documentation for Person-API
* `http://localhost:30011/api/` - Base path for person-API

* `http://localhost:30004/` - OpenAPI Documentation for Location-API
* `http://localhost:30004/api/` - Base path for API for Location-API

* `http://localhost:30010/` - Frontend ReactJS Application
